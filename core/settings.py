...
SECRET_KEY = 'django-insecure-czgfv4*3s32qxfubxe=9@tfskljkea@0udgl7zr08g0j$)wga+'
...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': 'https://console.firebase.google.com/project/nilaap-42c61/storage/nilaap-42c61.appspot.com/files',

    # https://console.firebase.google.com/project/nilaap-42c61/storage/nilaap-42c61.appspot.com/files
})
